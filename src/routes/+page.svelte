<script>
	...
	function buttonclick (betamount){
		...
		rotationInc=20+5*Math.random();spinning=true;
	}
...
<svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 width="20px" height="20px" viewBox="0 0 96.154 96.154"
	 xml:space="preserve">
<g>
...
<div class="flex">
<input bind:value={betamount} type="number" class="border rounded-2xl">

</div>
<button onclick={()=>{buttonclick(betamount)}} class="m-5 inline-flex h-12 items-center justify-center rounded-md bg-neutral-950 px-6 font-medium text-neutral-50 transition active:scale-110 ">Spin</button>
